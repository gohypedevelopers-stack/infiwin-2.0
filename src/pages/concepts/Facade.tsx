...
const DATA: ConceptDetailData = {
  ...
  description: "Our Façade concept reimagines the exterior envelope of modern buildings as a dynamic interplay of glass, light, and structure. From panoramic curtain walls to bespoke cladding solutions, every panel is engineered for seamless view, visual drama and easy maintenance.",
