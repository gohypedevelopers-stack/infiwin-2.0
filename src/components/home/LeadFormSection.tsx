      ...
      <div className="flex flex-col justify-center h-full gap-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            ...
            <a
              href={`https://wa.me/919136004100?text=${encodeURIComponent("Hi Infiwin, I am reaching out from your official website. I am interested in getting a Slide & Turn Balcony System. Please share your product catalog!")}`}
              target="_blank"
              rel="noreferrer"
