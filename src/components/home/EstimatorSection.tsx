...
export const EstimatorSection = () => {
  ...
  return (
    <div className="bg-slate-900 rounded-2xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden" id="estimator">
      <div className="relative z-10">
        ...
        <p className="text-white/60 font-light text-sm mb-10 max-w-md">
